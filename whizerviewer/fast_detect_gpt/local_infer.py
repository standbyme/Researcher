...
class ProbEstimator:
    def __init__(self, args):
        self.real_crits = []
        self.fake_crits = []
        with open(args.ref_path, 'r') as fin:
            res = json.load(fin)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--reference_model_name', type=str, default="meta-llama/Meta-Llama-3.1-8B")  # use gpt-j-6B for more accurate detection
    parser.add_argument('--scoring_model_name', type=str, default="meta-llama/Meta-Llama-3.1-8B")
    parser.add_argument('--dataset', type=str, default="xsum")
    parser.add_argument('--ref_path', type=str, default="local_infer_ref.json")
